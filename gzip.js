...
module.exports.gunzip = function(argobj,callback) {
  var gunzip
    , stdout = ''
    , stderr = ''
    ;
  function get_err(code) {
    if (code === 0) {
      return null;
    } else {
      return ''+code+': '+stderr;
  ...
  if (argobj.file) {
    gunzip = spawn('gunzip', [argobj.file]);
...
module.exports.gzip = function(data) {
  var rate = 8,
      enc = 'utf8',
